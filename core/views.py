...
from .models import Item, Order, OrderItem, Address, Payment, Coupon, Refund, Category
...
# This is the class based view for homepage. Not used for now
...
def index(request, slug=None):
    ...
    context = {'category': category, 'categories': categories, 'items': items}
            ...
            if form.is_valid():
                ...
                if use_default_shipping:
                    ...
                    if is_valid_form([shipping_address1]):
                        ...
                        messages.info(self.request, 'Please fill the required shipping address')
...
class RequestRefundView(View):
    ...
    def post(self, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            messages.info(self.request, 'Your entries are invalid. '
                                        'Contact customer care for help if you are having issues')
            return redirect('core:request-refund')
